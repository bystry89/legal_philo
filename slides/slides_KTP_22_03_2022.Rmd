...
.bottom[
.center[.title-author[Piotr Bystranowski&emsp;&bull;&emsp;INCET UJ] <br /><br />
.title-bottom[15 marca, 2022 r.<br />Katedra Teorii Prawa UJ]]]
---
# Metanauka
---
.left-column[# Projekt]
.right-column[.list1[- Opierając się na sieci współcytowań:]
.list2[- odnaleźć jądro współczesnej filozofii prawa,]
.list2[- wyodrębnić jej główne obszary zainteresowań oraz]
.list2[- opisać jej strukturę.]
.list1[- Przeanalizować stopień, w jakim różne obszary wchodzą ze sobą w interakcję.]
.list1[- Przeanalizować, w jakim stopniu poszczególne obszary cytowane są poza filozofią prawa.]
]
---
